...
def _(rid, params: dict) -> dict:
    """GET /api/billing/state → disabled in corporate edition."""
    return _ok(rid, {"ok": True, "logged_in": False, "error": "billing disabled in corporate edition"})


@method("usage.bars")
def _(rid, params: dict) -> dict:
    """Shared dollar usage model → disabled in corporate edition."""
    return _ok(rid, {"ok": True, "available": False})


@method("subscription.state")
def _(rid, params: dict) -> dict:
    """GET /api/billing/subscription → disabled in corporate edition."""
    return _ok(rid, {"ok": True, "logged_in": False, "error": "subscription disabled in corporate edition"})
